...
test('ein Tag mit Doppelpunkt ist ein Datenfeld, kein Kategorie-Tag', () => {
  assert.strictEqual(ollamaService._isPlausibleTag('Personal-Nr.: 003424 000'), false);
});
...
test('_normalizeParsedDocument filtert unplausible Tags aus dem Dokument', () => {
  const doc = {
    tags: ['Rechnung', 'Personal-Nr.: 003424 000', 'Versicherung'],
    document_date: null
  };
...
Baseline-Lauf zeigte Tags wie \"Personal-Nr.: 003424 000\" - keine
